...
$start_time = microtime(true);
	...
	foreach ($repertoire_ids as $repertoire_id)
	{
		...
		try {
			...
			// Handle errors in stats processing.
			// Exceptions would typically be generated by Mongo cursor operations.
			echo "ERROR: Could not process repertoire " . $repertoire_id . ", skipping to next repertoire";
