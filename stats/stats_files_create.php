...
*/
				...
				)
	{
		...
		$v_family_string = 'vgene_family';
		$v_gene_string = 'vgene_gene';

		$j_call_string = 'j_call';
		$j_family_string = 'jgene_family';
		$j_gene_string = 'jgene_gene';

		$d_call_string = 'd_call';
		$d_family_string = 'dgene_family';
		$d_gene_string = 'dgene_gene';

		$c_call_string = 'c_call';
		$c_family_string = 'cgene_family';
		$c_gene_string = 'cgene_gene';

		$productive_string = 'functional';

		$sequence_id = $rearrangement["_id"];
